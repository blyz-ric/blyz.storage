...
exports.utilCheckAndSaveUser = function(userData, callback) {
  ...
  User.create(userData, function(err, user) {
    console.log("eyy", userData, user, err)
    if(err || !user) {
...
exports.changePassword = function(req, res) {
  ...
  let projection = {
    updated: 1, firstname: 1, lastname: 1, username: 1, password_salt: 1, password_hash: 1, admin: 1
  }
...
exports.requestPasswordReset = function(req, res) {
  ...
  let projection = {
    firstname: 1, lastname: 1, username: 1, admin: 1, resetPasswordTime: 1, resetPasswordHex: 1
  }
